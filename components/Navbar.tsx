...
export default function Navbar({ locale, translations }: NavbarProps) {
    ...
    const navLinks = [
        ...
        { href: '/pantone', label: translations.pantone },
                        ...
                        <div className="flex items-center gap-8">
                            {navLinks.map((link) => (
                                <Link
                                    ...
                                    className={`text-xs font-mono uppercase tracking-widest transition-colors hover:text-zinc-900 dark:hover:text-white ${isActive(link.href) ? 'text-zinc-900 dark:text-white font-bold' : 'text-zinc-500 dark:text-zinc-400'
                                        }`}
                                >
                                    {link.label}
                                </Link>
                ...
                <div className="md:hidden border-t border-zinc-200 dark:border-zinc-900 bg-white dark:bg-zinc-950 px-4 pt-2 pb-4 space-y-3">
                    {navLinks.map((link) => (
                        <Link
                            ...
                            className={`block py-2 text-sm font-mono uppercase tracking-wider ${isActive(link.href) ? 'text-zinc-900 dark:text-white font-bold' : 'text-zinc-500 dark:text-zinc-400'
                                }`}
                        >
                            {link.label}
                        </Link>
